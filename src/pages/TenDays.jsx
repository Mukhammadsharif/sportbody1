  ...
  return (
    <SafeAreaView style={styles.safeAreaView}>
      <ImageBackground source={BackgroundImage} style={styles.container}>
        ...
        <Text style={styles.title}>10-дневный план</Text>
        ...
        <ScrollView
          ...
          {plan.training.slice(6, 15).map((training, index) => (
            <TouchableOpacity
              key={index}
              onPress={() =>
                navigation.navigate('Detail', {training, routeName: 'TenDays'})
              }
              style={styles.button}>
        ...
        <Text style={styles.text}>
          {plan.training.slice(6, 15).reduce((total, activity) => {
